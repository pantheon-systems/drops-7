(function( $ ){
  $(document).ready(function(){
    ...
    $('.form-item-core-roles input').attr('data-role-reset', 'true');

    $(elevatedRoles).each(function(){

      $('#edit-core-roles-' + this +':not(:checked)').attr('data-role-reset', 'false');
      $('#edit-core-roles-' + this +':not(:checked)').change(function(){
        var roleID = $(this).val();
      ...
      $('#edit-addon-roles-' + this +':not(:checked)').change(function(){
        var roleID = $(this).val();
