<div class="thumbnail-overlay-slider-wrapper">
  ...
  <div class="cu-slider-thumbnails element-max-width" data-slider-controls="slider-<?php print $bean->bid; ?>" id="slider-thumbnails-<?php print $bean->bid; ?>">
    <?php
      print render($content['field_slider_slide']);
    ?>
  </div>
