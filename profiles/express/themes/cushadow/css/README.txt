...
To use these stylesheets, rename the files and envd_omega with the name of your theme.
...
envd_omega-alpha-default-narrow.css  
...
envd_omega-alpha-default-normal.css
...
envd_omega-alpha-default-wide.css
