...
<?php if (isset($title_image) && !drupal_is_front_page()): ?>
      <div id="page-title-image-wrapper" class="page-title-image-wrapper <?php print $title_image_wrapper_class; ?>" >
        <div id="page-title-image" class="<?php print $title_image_title_class; ?>" style="background-image:url(<?php print $title_image; ?>);">
