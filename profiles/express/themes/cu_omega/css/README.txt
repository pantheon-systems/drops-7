...
To use these stylesheets, rename the files and cu_omega with the name of your theme.
...
cu_omega-alpha-default-narrow.css  
...
cu_omega-alpha-default-normal.css
...
cu_omega-alpha-default-wide.css
