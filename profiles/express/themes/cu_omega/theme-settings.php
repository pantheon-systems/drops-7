...
function cu_omega_form_system_theme_settings_alter(&$form, &$form_state) {
  $theme = $form_state['build_info']['args'][0];
	$form['cu_omega_theme_settings'] = array(
		'#type' => 'fieldset',
		'#title' => t('Theme Settings'),
	);

	$form['cu_omega_theme_settings']['typography'] = array(
		'#type' => 'fieldset',
		'#title' => t('Typography'),
		'#collapsible' => TRUE,
		'#collapsed' => TRUE,
	...
	$form['cu_omega_theme_settings']['typography']['headings'] = array(
	  '#type' => 'radios',
    ...
    $form['cu_omega_theme_settings']['page_title_image'] = array(
  		'#type' => 'fieldset',
  		'#title' => t('Page Title Image'),
  		'#collapsible' => TRUE,
  		'#collapsed' => TRUE,
  	);
  	$form['cu_omega_theme_settings']['page_title_image']['page_title_image_background'] = array(
  	  '#type' => 'radios',
  	...
  	$form['cu_omega_theme_settings']['page_title_image']['page_title_image_width'] = array(
  	  '#type' => 'radios',
	...
	$form['cu_omega_theme_settings']['columns'] = array(
		'#type' => 'fieldset',
		'#title' => t('Column Options'),
		'#collapsible' => TRUE,
		'#collapsed' => TRUE,
	);
	$form['cu_omega_theme_settings']['columns']['after_content_columns'] = array(
	  '#type' => 'radios',
	 ...
	 $form['cu_omega_theme_settings']['columns']['lower_columns'] = array(
	  '#type' => 'radios',
  ...
  $form['cu_omega_theme_settings']['columns']['footer_columns'] = array(
	  '#type' => 'radios',
	...
	$form['cu_omega_theme_settings']['breadcrumbs'] = array(
		'#type' => 'fieldset',
		'#title' => t('Breadcrumbs'),
		'#collapsible' => TRUE,
		'#collapsed' => TRUE,
	);
	$form['cu_omega_theme_settings']['breadcrumbs']['use_breadcrumbs'] = array(
    '#type' => 'checkbox',
  ...
  $form['cu_omega_theme_settings']['action_menu'] = array(
    '#type' => 'fieldset',
    '#title' => t('Secondary Menu'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  $form['cu_omega_theme_settings']['action_menu']['use_action_menu'] = array(
    '#type' => 'checkbox',
    '#title' => t('Placement'),
  ...
  $form['cu_omega_theme_settings']['action_menu']['action_menu_color'] = array(
	  '#type' => 'radios',
	  '#title' => t('Color'),
	...
	$form['cu_omega_theme_settings']['footer_menu'] = array(
    '#type' => 'fieldset',
    '#title' => t('Footer Menu'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  $form['cu_omega_theme_settings']['footer_menu']['footer_menu_color'] = array(
	  '#type' => 'radios',
	  '#title' => t('Color'),
	...
	$form['cu_omega_theme_settings']['block_icons'] = array(
    '#type' => 'fieldset',
    '#title' => t('Block Icons'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  $form['cu_omega_theme_settings']['block_icons']['block_icons_color'] = array(
	  '#type' => 'radios',
	  '#title' => t('Color'),
