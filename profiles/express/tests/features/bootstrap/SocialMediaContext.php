 ...
 */
class SocialMediaContext extends RawDrupalContext implements SnippetAcceptingContext {
  ...
  public static function prepare($scope) {
    ...
    //module_enable(array('cu_social_media_bundle'));
  ...
  public static function tearDown($scope) {
    //module_disable(array('cu_social_media_bundle'));
    //drupal_uninstall_modules(array('cu_social_media_bundle'));
    //drupal_flush_all_caches();
  }
