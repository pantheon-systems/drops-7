...
/**
 * @file
 * Contains beautytips_instance_ui.
 */

class beautytips_instance_export_ui extends ctools_export_ui {
  /**
  ...
  function list_table_header() {
    ...
    $header[] = array('data' => t('Element'));
    $header[] = array('data' => t('Style'));
    $header[] = array('data' => t('Visibility'));
    $header[] = array('data' => t('Pages'));
